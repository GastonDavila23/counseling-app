            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left">
                        ...
                        {/* Título */}
                        <h3 className="text-3xl md:text-4xl font-bold text-counseling-dark dark:text-counseling mb-6 font-sans transition-colors duration-300">
                        ...
                        <div className="space-y-4 text-sm md:text-lg text-gray dark:text-gray-light leading-relaxed transition-colors duration-300">
                            ...
                            <p>
                                Estoy convencida de que el bienestar surge cuando nuestras acciones son coherentes con nuestro sentir. Por eso, mi propósito es brindarte un espacio seguro y libre de juicios donde puedas explorarte, gestionar tus emociones y reconocer los recursos que habitan en vos.
                            </p>
                            <p>
                                Juntos, trabajaremos para fortalecer tu identidad y autoestima y construir vínculos más sanos y auténticos, encontrando ese equilibrio para transitar los desafíos de la vida con mayor claridad y autonomía.
                            </p>
                        </div>
